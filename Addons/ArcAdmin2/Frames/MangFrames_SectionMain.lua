...
--      color = {66, 164, 210, transparency.btn}
----      color = {color.btn.r, color.btn.g, color.btn.b, transparency.btn}
--    },
--    size = {
--      width = 40,
