...
function Return_enUS()
  return {
    ...
    ["tt_HoverOnButton"] = "Activate your God-mode.",
    ["tt_HoverOffButton"] = "Deactivate your God-mode.",
    ["tt_WhispOnButton"] = "Toggles Invincibility.",
    ["tt_InvisOnButton"] = "Toggles Invisibility.",
    ...
    ["tt_BankButton"] = "Mounts selected character on ModelID [P], entered below.",
    ...
    ["tt_CooldownButton"] = "Toggles the cooldown cheat on the selected character.",
    ...
    ["tt_TicketOn"] = "Toggle the Ticket System On/Off.",
    ["tt_TicketOff"] = "Don't announce new tickets.",
    ["info_revision"] = "|cFF00FF00ArcEmu Revision:|r ",
    ["info_platform"] = "|cFF00FF00Platform:|r ",
    ["info_online"] = "|cFF00FF00Players Online:|r ",
    ["info_maxonline"] = "|cFF00FF00Latency:|r ",
