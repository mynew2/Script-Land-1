...
function KickPlayer()
  if MangAdmin:Selection("player") or MangAdmin:Selection("self") or MangAdmin:Selection("none") then
    local player = UnitName("target") or UnitName("player")
    MangAdmin:ChatMsg(".kick byplayer")
...
function Cooldown()
  if MangAdmin:Selection("player") or MangAdmin:Selection("self") or MangAdmin:Selection("none") then
    local player = UnitName("target") or UnitName("player")
    MangAdmin:ChatMsg(".clearcooldowns")
...
--[[function Distance()
    local player = UnitName("target") or UnitName("player")
    MangAdmin:ChatMsg(".debug getheight rangecheck")
...
function Recall()
  if MangAdmin:Selection("player") or MangAdmin:Selection("self") or MangAdmin:Selection("none") then
    local player = UnitName("target") or UnitName("player")
    MangAdmin:ChatMsg(".recall portplayer")
...
function Reset(value)
  if MangAdmin:Selection("player") or MangAdmin:Selection("self") or MangAdmin:Selection("none") then
    local player = UnitName("target") or UnitName("player")
    MangAdmin:ChatMsg(".char resettalents "..value)
	MangAdmin:ChatMsg(".char resetspells "..value)
	MangAdmin:ChatMsg(".char resetskills "..value)
	MangAdmin:ChatMsg(".char resetreputation "..value)
