...
function BanButton()
  ...
  MangAdmin:ChatMsg(".ban char "..cname)
...
function UnBanButton()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  MangAdmin:ChatMsg(".unban char "..cname)
...
function GuildDeleteButton()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  MangAdmin:ChatMsg(".guild disband "..cname)
...
function MuteButton()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  MangAdmin:ChatMsg(".account mute "..cname)
...
function CharMorphButton()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  MangAdmin:ChatMsg(".modify displayid "..cname)
  MangAdmin:LogAction(".modify displayid "..cname..".")
...
function CharUnAuraButton()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  MangAdmin:ChatMsg(".removeauras "..cname)
  MangAdmin:LogAction(".removeauras "..cname..".")
...
--[[function JailA()
    ...
    MangAdmin:ChatMsg(".announce "..cname.." has been found guilty and jailed.")
end
...
function UnJail()
    ...
    MangAdmin:ChatMsg(".announce "..cname.." has been pardoned and released from jail.")
end]]

function UnMuteButton()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  MangAdmin:ChatMsg(".account unmute "..cname)
  MangAdmin:LogAction(".account unmute "..cname..".")
...
function QuestAddButton()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  MangAdmin:ChatMsg(".quest start "..cname)
  MangAdmin:LogAction(".quest start "..cname..".")
...
function DamageButton() --Custom ArcEmu Command
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  MangAdmin:ChatMsg(".damage "..cname)
  MangAdmin:LogAction(".damage "..cname..".")
  MangAdmin:LogAction("This script won't work without the lua script in the script folder.")
end
...
function HonorAddButton()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  MangAdmin:ChatMsg(".honor addpoints"..cname)
  MangAdmin:LogAction(".honor addpoints "..cname..".")
end

function HonorUpdateButton()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  MangAdmin:ChatMsg(".honor globaldailyupdate ")
  MangAdmin:LogAction(".honor globaldailyupdate.")
end
