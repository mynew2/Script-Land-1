...
--    tNumber = string.match(tNumber, "%d+")
    MangAdmin:ChatMsg(".char info "..tChar)
...
--   ChatEdit_FocusActiveWindow(1);
  ...
  elseif value == "1dayban" then
    MangAdmin:ChatMsg(".ban char "..ma_who:GetText().." 1d 1Day ban by GM")
  elseif value == "permban" then
    MangAdmin:ChatMsg(".ban char "..ma_who:GetText().." -1d Permanent ban by GM")
