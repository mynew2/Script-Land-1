...
function OBJGo()
    ...
    MangAdmin:ChatMsg(".go object "..obj" 1")
...
function OBJAdd()
    ...
    MangAdmin:ChatMsg(".gobject spawn "..obj)
...
function OBJTurn()
    local player = UnitName("target") or UnitName("player")
    local obj =	ma_Obj_guidbutton:GetText()
    MangAdmin:ChatMsg(".gobject rotate "..obj)
    MangAdmin:LogAction("Object rotated for player "..player..".")
end
...
function OBJNear()
    local player = UnitName("target") or UnitName("player")
    MangAdmin:ChatMsg(".gobject select")
    MangAdmin:LogAction("Object selected for player "..player..".")
end
...
function OBJTarget()
	if gettingGOBinfo == 0 and gettingGOBinfoinfo == 0 then
        ...
        MangAdmin:ChatMsg(".gobject selet")
        MangAdmin:LogAction("Object selected for player "..player..".")
...
function DMSS2()
        ...
        if isChecked == 1 then  --AddonMove
            ...
            SendChatMessage('.gobject spawn '..ObjectN' 1')
